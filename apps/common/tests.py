...
class TestAPIResponse:
    ...
    def test_success_response_with_meta(self):
        ...
        response = APIResponse.success(data={"test": "data"}, meta={"pagination": {"page": 1}})
    ...
    def test_not_found_response(self):
        ...
        response = APIResponse.not_found(message="Resource not found", data={"requested_id": 123})
    ...
    def test_validation_error_response(self):
        ...
        response = APIResponse.validation_error(errors=errors, message="Validation failed")
    ...
    def test_paginated_response_last_page(self):
        ...
        response = APIResponse.paginated_response(data=[{"id": 21}], page=3, per_page=10, total=21)
